...
var $REG_URL=/((https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?)/g,alias=[["bago","ပဲခူး"],["rakhing","ရခိုင်"],["kayin","ကရင်"],["ayeyarwaddy","ဧရာ၀တီ","ဧရာဝတီ"]];$("#search-at-header").on("keyup",function(a){var t=$(this),n=t.val();n=n.toLowerCase();var c=[];n.split(" ").forEach(function(a){var t=!1;alias.forEach(function(n){-1!==n.indexOf(a)&&(t=!0,c=c.concat(n))}),t||c.push(a)}),c=c.join("|"),$("#donation-groups .mdl-card").each(function(a,t){t=$(t),t.attr("data-search").match(c,"gi")?t.show(400):t.hide(400)}),$("#new-feed .mdl-card").each(function(a,t){t=$(t),t.attr("data-search").match(c,"gi")?t.show(400):t.hide(400)})});
function closeModel(){$("#overlay").remove(),$("#group-modal").remove()}var baseURL="https://floodinfo-myanmar.herokuapp.com/api/",donationGroupURL=baseURL+"donation_groups",newsURL=baseURL+"newsfeeds";Vue.filter("truncate",function(t,n){return t.length<n?t:(n-=3,t.substring(0,n)+"...")});var donationGroup=new Vue({el:"#donation-groups",data:{groups:null,total:null,loading:!0},ready:function(){this.$http.get(donationGroupURL,function(t,n,i){t=t.map(function(t){return t.description=t.description.replace($REG_URL,function(t,n){return"<a href='"+n+"'> "+n+" </a>"}),t.title=kny.fontConvert(t.title,"unicode5"),t.description=kny.fontConvert(t.description,"unicode5"),t}),this.$set("groups",t),this.$set("total",t.length),this.$set("loading",!1)}).error(function(t,n,i){})},methods:{showDetailBox:function(t,n,i){var o='<div class="modal mdl-shadow--2dp" id="group-modal"><div class="modal-content"><h4>Description</h4><p>'+t+"</p><h4>Phone Numbers</h4><p>"+n+"</p><h4>Location</h4><p>"+i+'</p></div><div class="modal-footer"><button class="mdl-button mdl-js-button" id="close-modal">Close</button></div></div>',e=$("body");e.append(o),e.append('<div id="overlay"></div>'),$("#close-modal").on("click",function(){closeModel()})}}}),newDonationGroup=new Vue({el:"#new-donation-groups",data:{invalidTitle:!1,newIsPosting:!1},methods:{postGroup:function(t){t.preventDefault();var n=this.title;if((""===n||"undefined"==typeof n)&&(this.invalidTitle=!0),this.invalidTitle)return!0;var i={title:n,description:this.description,phone_numbers:this.phone_numbers,donation_location:this.donation_location,facebook_url:this.facebook_url};this.invalidTitle=!1,this.newIsPosting=!0,this.$http.post(donationGroupURL+"/",i,function(t,n,i){this.newIsPosting=!1,document.location.href="/"},{emulateJSON:!0}).error(function(t,n,i){alert("Error: Please try again to post your donation group...")})}}}),newsfeeds=new Vue({el:"#new-feed",data:{news:null,loading:!0,invalidTitle:!1,invalidDescription:!1,newIsPosting:!1},ready:function(){this.$http.get(newsURL,function(t,n,i){t=t.map(function(t){return t.description=t.description.replace($REG_URL,function(t,n){return"<a href='"+n+"'> "+n+" </a>"}),t.title=kny.fontConvert(t.title,"unicode5"),t.description=kny.fontConvert(t.description,"unicode5"),t}),this.$set("news",t),this.$set("loading",!1)}).error(function(t,n,i){})},methods:{postNew:function(t){t.preventDefault();var n=this.title,i=this.description;return(""===n||"undefined"==typeof n)&&(this.invalidTitle=!0),(""===i||"undefined"==typeof i)&&(this.invalidDescription=!0),this.invalidTitle||this.invalidDescription?!0:(this.invalidTitle=!1,this.invalidDescription=!1,this.newIsPosting=!0,void this.$http.post(newsURL,{title:n,description:i},function(t,n,i){this.newIsPosting=!1,this.news.unshift(t)},{emulateJSON:!0}).error(function(t,n,i){alert("Error: Please try again to post your new...")}))},reportNew:function(t){var n=newsURL+"/"+t+"/report_as_spam";this.$http.get(n,function(t,n,i){alert("Thanks for your report")}).error(function(t,n,i){alert("Error: Please try again to report...")})}}});