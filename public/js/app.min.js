...
$(function(){
  ...
  function initialize() {
    ...
    locMakers.kunyi = locations.map(function(loc){
      return new Marker(loc.latitude, loc.longitude, "kunyi", loc["Township"]);
    });

    locMakers.kokoye = locations2.map(function(loc){
      return new Marker(loc.coordinates[0], loc.coordinates[1], "kokoye", loc["mm_name"]);
    });
